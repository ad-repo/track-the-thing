          ...
          <div className="grid gap-4 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
            <div className="space-y-4">
              <div className="space-y-3 p-4 rounded-lg" style={{ backgroundColor: 'var(--color-bg-secondary)' }}>
                ...
                {(() => {
                  ...
                  return (
                    <div className="px-3 py-2 rounded" style={{ backgroundColor: 'var(--color-bg-primary)', border: '1px solid var(--color-border-primary)' }}>
                      ...
                      <p className="text-xs mt-1" style={{ color: 'var(--color-text-secondary)' }}>
                        {selectedElements.size > 0
                          ? 'Click any pattern below to update the selected elements.'
                          : 'Click an element card to toggle textures or select it for editing.'}
                      </p>
                    </div>
                  );
                })()}
                  ...
                  {ELEMENT_TYPES.map(({ type, label, icon }) => {
                    ...
                    return (
                      <button
                        ...
                        style={{
                          backgroundColor: hasPattern ? 'var(--color-accent)' + '25' : 'var(--color-bg-primary)',
                          color: 'var(--color-text-primary)',
                          border: hasPattern ? `2px solid var(--color-accent)` : `1px solid var(--color-border-primary)`,
                          opacity: textureEnabled ? 1 : 0.5,
                          cursor: 'pointer',
                        }}
                      >
            ...
            <div className="space-y-4">
              <div className="space-y-3 p-5 rounded-lg" style={{ backgroundColor: 'var(--color-bg-secondary)' }}>
                <h3 className="text-md font-semibold flex items-center gap-2 mb-2" style={{ color: 'var(--color-text-primary)' }}>
